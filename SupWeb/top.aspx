...
<body class='inner' runat="server" id="body1" onmouseover="self.status='';return true" onmousedown="self.status='';return true" >
 <div class="bg-top">
   <div id="header" style="left: 4px; top: 0px; height: 77px;">
        ...
        <div class='homepagelink' style="right: 10px; top: 14px"><a href="http://www.api-hk.com/en/home" target="_blank"></a></div><div id="timeShow" style="top: 14px; right: 200px; position: absolute; font-size: x-small;
