<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="bot.aspx.cs" Inherits="Web_bot" %>
...
<body class='inner' runat="server" id="body1" onmouseover="self.status='';return true" onmousedown="self.status='';return true" >
 <div class="bg-footer">
            	...
            	<div class="footer-l">
					...
					<ul class="menu"><li class="item119"><a href="http://www.api-hk.com/en/home" target="_blank"><span>Home</span></a></li><li class="item23"><a href="http://www.api-hk.com/en/privacy-policy" target="_blank"><span>Privacy Policy</span></a></li><li class="item25"><a href="http://www.api-hk.com/en/site-map" target="_blank"><span>Site Map</span></a></li><li class="item32"><a href="http://www.api-hk.com/en/archived" target="_blank"><span>Archived</span></a></li><li class="item116"><a href="http://www.api-hk.com/en/terms-of-use" target="_blank"><span>Terms of Use</span></a></li></ul>		</div>
	</div>
                    <div class="copyright">		<div class="moduletable">
					<p>Copyright <a href="Main.aspx" class="copy">&copy;</a> 2011 Asia Pacific Inspection Ltd. All Rights Reserved.</p>		</div>
	</div>
                </div>
